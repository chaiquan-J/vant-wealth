<template>
	<div class="discovery">
		<div class="discovery_body">
			...
			<div class="tab_one">
				<van-tabs v-model="tab_one_active" swipeable line-width="12px" color="#2772FF" title-active-size="20px" title-active-color="#2772FF" title-inactive-color="#000">
					<template v-for="(item, key) in tab_one">
						<van-tab :title="item" :key="key">
							<div class="cont_box">
								<div class="interior_box">
									<span class="title">内需消费</span>
									<div class="card_box">
										<div class="card_top">
											<span>投资潜力</span>
...
<style lang="less">
@import url(../common/vuestyle.less);
</style>
<style lang="less" scoped>
@import url(../common/discovery.less);
</style>
